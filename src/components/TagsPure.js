...
import { springairpure } from '../data/Springair'
...
const Tags = () => {
    return (
        ...
        <Row>
        {springairpure.map(t=> (            
                <Col lg={4} md={4} sm={4} xs={4} className='d-flex my-1 px-1' key={t.style}>
                <Card border='dark' className=' w-100 p-1' >
                    <span className='d-flex justify-content-center'><Card.Img variant="top" src={process.env.PUBLIC_URL + `/${t.image}`} className='w-25 pb-4 pt-5' /></span>
                    ...
                    <ListGroup className='m-0 p-0' variant='flush'>
                        ...
                        <ListGroup.Item className='m-0 mb-3 p-1 pb-5 d-flex'>
                            <h5 className='pr-4 pb-5'>PRICE: </h5><p></p>
                        </ListGroup.Item>
                    </ListGroup>
                    </Card.Body>
                    </Card>
